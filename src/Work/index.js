...
const Work = () => {
  return (
    <div
      id="work"
      className="d-flex flex-column justify-content-center container px-3 min-vh-100 my-4 overflow-hidden"
    >
      <h1 className="mb-5 display-6 fw-bold" id="work">
        <u>My Work</u>
      </h1>
                ...
                >
                  <div className="project-card-wrapper">
                    <div className="position-absolute top-50 start-50 translate-middle">
                      <img
                        src={image}
                        className="img-fluid animate__animated shadow"
                        alt={title}
                      ></img>
                    </div>
